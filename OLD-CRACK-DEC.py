...
def crack(idf, pwv):
    ...
    fff = '%'
    (sys.stdout.write('\r %s[ Proces start] %s\xe2\x80\xa2%s \xe2\x80\xa2 OK:%s \xe2\x80\xa2 CP:%s  ' % (bi, loop, len(id2), len(ok), cp)),)
    sys.stdout.flush()
